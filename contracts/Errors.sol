...
contract Errors {
    ...
    function withdraw(uint256 _amount) noZero(_amount) external {
        uint256 initalBalances = totalBalance;
    ...
    // bir fonksiyonu dışardan özellikle çağırmadan önce kontratmızda yapmamız gereken değişiklikleri yapmamız gerekiyor 
    ...
    assert(totalBalance < initalBalances);
